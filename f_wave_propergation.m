...
assert(length(sz_source_distribution{1})==2,'The shape of source_distribution is not correct!')
...
assert(sz_target_position(1)==1 && sz_target_position(2)==3 && length(sz_focus_length)==2,'The shape of target_position is not correct!')
...
assert(target_position(3)>lens2source,'lens_radius should not be equal nor smaller than 0!')
%% Calculations
% simple notations
...
!!! One should pad the distribution before using it!!!
